...
<template>
  <v-app-bar elevation="0" :priority="priority" height="74" class="px-sm-10 px-5">
    <div class="py-5 pr-16 hidden-md-and-down">
      <Logo />
    </div>
    <v-btn
    ...
    <v-menu :close-on-content-click="false" class="hidden-lg-and-up" offset="10, 0">
      <template v-slot:activator="{ props }">
        <v-btn class="hidden-lg-and-up text-secondary ml-1" color="secondary" icon rounded="sm" variant="text" size="small" v-bind="props">
    ...
    <v-menu :close-on-content-click="false" location="bottom" offset="6, 80">
      <template v-slot:activator="{ props }">
        <v-btn icon class="ml-sm-2 ml-1" color="secondary" rounded="sm" v-bind="props">
    ...
    <!-- Message -->
    <!-- ---------------------------------------------- -->
    <v-btn icon class="ml-sm-2 ml-1" color="secondary" rounded="sm" @click.stop="messagedrawer = !messagedrawer">
    ...
    <v-menu :close-on-content-click="false" offset="8, 0">
      <template v-slot:activator="{ props }">
        <v-btn class="profileBtn mr-0" variant="text" rounded="circle" icon v-bind="props">
      ...
      <v-list class="px-5" aria-label="message list" aria-busy="true">
        ...
        <v-list-item class="px-0">
          <v-card variant="outlined">
            <v-card-text>
              ...
              <span class="ml-2 text-caption">just now</span>
              <v-badge dot color="warning" size="small" inline></v-badge>
              <h6 class="text-subtitle-1 my-3">Select Business Unit</h6>
              <p class="text-h6 mb-2">You can use the Analytics Dashboard to explore how many new users download reports daily and monthly</p>
        ...
        <v-list-item class="px-0 pt-2">
          <v-card variant="outlined">
            <v-card-text>
              ...
              <span class="ml-2 text-caption">2 min ago</span>
              <v-badge dot color="warning" size="small" inline></v-badge>
        ...
        <v-list-item class="px-0">
          <v-card variant="outlined">
            <v-card-text>
              ...
              <span class="ml-2 text-caption">2 hours ago</span>
              <v-badge dot color="warning" size="small" inline></v-badge>
        ...
        <v-list-item class="px-0 pt-2 pb-4">
          <v-card variant="outlined">
            <v-card-text>
              <v-chip color="primary" variant="tonal" size="small">Improvement</v-chip>
              <span class="ml-2 text-caption">1 day ago</span>
              <v-badge dot color="warning" size="small" inline></v-badge>
